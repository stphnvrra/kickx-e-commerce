...
PAYPAL_CLIENT_ID = os.environ.get('PAYPAL_CLIENT_ID', 'AaHF2aq2vTkFp6_GQWIYCCiA3nS7BLEEKFhstroztRD1YGCXHtB2YLBuYG3i50o7O2MDryfWxd9gESQL')
PAYPAL_CLIENT_SECRET = os.environ.get('PAYPAL_CLIENT_SECRET', 'ECO0xX_6Jb7M2uQctvZVtQbVWtjeDUwyps6VIlnkHzMaSfShTlOSSeoZH9awqwc0r4pp5xhAmoZZNzb9')
PAYPAL_MODE = os.environ.get('PAYPAL_MODE', 'live')  # Changed from 'sandbox' to 'live' for production
